...
* глубже погрузилась в React: хуки, поднятие состояний, функциональные компоненты, рефы и пр.
...
* написать backend на Node.js и MongoDB, реализовать чат на socket.io, прописать запросы к API
